                ...
                <div class="content">
                    ...
                    <div class="grid grid-cols-12 gap-6 mt-5">
                        <div class="intro-y col-span-12 lg:col-span-12">
                            <!-- BEGIN: Form Layout -->
                            <form action="/ketpng/store" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="mb-5">
                                    <label for="kategori_pelanggaran" class="form-label">Nama Penanganan</label>
                                    <input type="text" name="nama_kategori_penanganan" class="form-control">
                                </div>
                                <div class="mb-5">
