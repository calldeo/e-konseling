                ...
                <div class="content">
                    ...
                    <div class="grid grid-cols-12 gap-6 mt-5">
                        <div class="intro-y col-span-12 lg:col-span-12">
                            <!-- BEGIN: Form Layout -->
                            <form action="/ketplg/store" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="mb-5">
                                    <label for="kategori_pelanggaran" class="form-label">Nama Pelanggaran</label>
                                ...
                                <div class="mb-5">
                                    ...
                                    <input type="text" name="deskripsi_pelanggaran" class="form-control">
                                </div>
                                <div class="mb-5">
