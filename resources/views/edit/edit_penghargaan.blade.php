                ...
                <div class="content">
                    ...
                    <div class="grid grid-cols-12 gap-6 mt-5">
                        <div class="intro-y col-span-12 lg:col-span-12">
                            <!-- BEGIN: Form Layout -->
                            <form action="/penghargaan/{{ $id_penghargaan }}" method="POST" enctype="multipart/form-data">
                                @method('put')
                                @csrf
                                <div  class="mb-5">
                                ...
                                <div  class="mb-5">
                                    <label for="id_kategori_penghargaan" class="form-label">Penghargaan</label>
                                    <div  >
                                        <select class="tom-select w-full"  onchange="getPoint(this)" name="id_kategori_penghargaan" required>
                                            {{-- <option value="">Pilih Kategori Pelanggaran</option> --}}
                                            @foreach ($penghargaan as $phg)
                                            <option  value="">--PILIH PENGHARGAAN--</option>
                                            <option value="{{ $phg->id_kategori_penghargaan}}">{{ $phg->kategori_penghargaan }}</option>
            ...
            @include('template.scricpt')
                <script>
                    function getPoint(selectObject) {
                        var data = <?php echo json_encode($penghargaan)?>;
                        data.forEach(element => {
                            if(element.id_kategori_penghargaan == selectObject.value) {
                                console.log(element);
