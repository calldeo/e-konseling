<nav class="side-nav">
    ...
    <li>
        <a href="/home" class="side-menu side-menu--active">
    ...
    <li>
        <a href="/siswa" class="side-menu side-menu--active">
    ...
    <li>
        <a href="/guru" class="side-menu side-menu--active">
            <div class="side-menu__icon"> <i data-lucide="user"></i> </div>
            <div class="side-menu__title">
                Guru
            </div>
        ...
        <li>
            ...
            <ul class="side-menu__sub-open">
                <li>
                    <a href="/pelanggaran" class="side-menu ">
                        <div class="side-menu__icon"> <i data-lucide="activity"></i> </div>
                        <div class="side-menu__title"> Pelanggaran </div>
                    </a>
                </li>
                <li>
        ...
        <li>
            ...
            <ul class="side-menu__sub-open">
                <li>
                    <a href="/penghargaan" class="side-menu side-menu--active">
                        <div class="side-menu__icon"> <i data-lucide="award"></i> </div>
                        <div class="side-menu__title"> Penghargaan </div>
                    </a>
                </li>
                <li>
        ...
        <li>
            ...
            <ul class="side-menu__sub-open">
                <li>
                    <a href="/riwayat" class="side-menu side-menu--active">
                        <div class="side-menu__icon"> <i data-lucide="history"></i> </div>
                        <div class="side-menu__title"> Riwayat </div>
                    </a>
                </li>
                <li>
        ...
        <li>
            ...
            <ul class="side-menu__sub-open">
                <li>
                    <a href="/penanganan" class="side-menu side-menu--active">
