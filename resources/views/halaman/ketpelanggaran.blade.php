...
<html lang="en" class="light">
    ...
    <title>Kategori Pelanggaran - Si Beka</title>
    <!-- BEGIN: CSS Assets-->
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu w-40">
                                    <ul class="dropdown-content">
                                        <li>
                                            <a href="/tambah_ketplg" class="dropdown-item"> <i data-lucide="file-text" class="w-4 h-4 mr-2"></i> Tambah Kategori Pelanggaran </a>
                                        </li>
                                        <li>
                            ...
                            <table class="table table-report -mt-2">
                                ...
                                <tbody>
                                 ...
                                 {{-- <tr onclick="window.location.href = '/ketpelanggaran/{{ $kp->id_kategori_pelanggaran }}/edit_ketpelanggaran'" class="cursor-pointer"> --}}
                                        <td  class="text-center">{{$kp->id_kategori_pelanggaran}}</td>
                                        <td  class="text-center">{{$kp->kategori_pelanggaran}}</td>
                                        <td class="text-center">{{$kp->deskripsi_pelanggaran}}</td>
                                        <td class="text-center">{{$kp->point}}</td>
                                        {{-- <td class="text-center">{{$g->password}}</td> --}}

                                        <td class="table-report__action w-40">
                                            <div class="flex justify-center items-center">
                                                <a class="btn btn-primary" href="/ketpelanggaran/{{ $kp->id_kategori_pelanggaran }}/edit_ketpelanggaran" >
                                                    <i data-lucide="edit" class="w-4 h-4 mr-1"></i>
                                                </a>
                                                
                                                <form action="{{ route('ketpelanggaran.destroy', $kp->id_kategori_pelanggaran) }}" method="POST" class="delete-form">
                                                    @csrf
                                                    @method('DELETE')
                            ...
                            <div class="modal-content">
                                <div class="modal-body p-0">
                                    ...
                                    <div class="px-5 pb-8 text-center">
                                        <form action="/ketpelanggaran/{{ $kp->id_kategori_pelanggaran }}" method="POST">
                                            @csrf
                                            @method('delete')
