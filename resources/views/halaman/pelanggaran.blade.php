                                ...
                                <tbody>
                                    ...
                                    <td class="table-report__action w-40">
                                        <div class="flex justify-center items-center">
                                            <a class="btn btn-primary" href="/pelanggaran/{{ $da->id_pelanggaran }}/edit_pelanggaran" >
                                                <i data-lucide="edit" class="w-4 h-4 mr-1"></i>
                                            </a>
                                            
                                            <form action="{{ route('pelanggaran.destroy1', $da->id_pelanggaran) }}" method="POST" class="delete-form">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit" class="btn btn-danger" data-toggle="modal" data-target="#delete-confirmation-modal-{{ $da->id_pelanggaran }}">
