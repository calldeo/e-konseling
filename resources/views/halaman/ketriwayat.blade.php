                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu w-40">
                                    <ul class="dropdown-content">
                                        <li>
                                            <a href="/tambah_ketrwt" class="dropdown-item"> <i data-lucide="printer" class="w-4 h-4 mr-2"></i> Tambah Guru </a>
                                        </li>
                                        <li>
                            ...
                            <table class="table table-report -mt-2">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center whitespace-nowrap">Nama Riwayat</th>
                                ...
                                <tbody>
                                 @foreach($ketriwayat as $kp)
                                 {{-- <tr onclick="window.location.href = '/ketpelanggaran/{{ $kp->id_kategori_pelanggaran }}/edit_ketpelanggaran'" class="cursor-pointer"> --}}
                                        <td  class="text-center">{{$kp->id_kategori_riwayat}}</td>
                                        <td  class="text-center">{{$kp->nama_kategori_riwayat}}</td>
                                        ...
                                        <td class="table-report__action w-56">
                                            <div class="flex justify-center items-center">
                                                <a class="flex items-center mr-3" href="/ketriwayat/{{ $kp->id_kategori_riwayat }}/edit_ketriwayat"> <i data-lucide="check-square" class="w-4 h-4 mr-1"></i> Edit </a>
                            ...
                            <div class="modal-content">
                                <div class="modal-body p-0">
                                    ...
                                    <div class="px-5 pb-8 text-center">
                                        <form action="/ketriwayat/{{ $kp->id_kategori_riwayat}}" method="POST">
                                            @csrf
                                            @method('delete')
