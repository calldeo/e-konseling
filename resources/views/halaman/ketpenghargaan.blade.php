                            ...
                            <table class="table table-report -mt-2">
                                ...
                                <tbody>
                                 ...
                                 {{-- <tr onclick="window.location.href = '/ketpelanggaran/{{ $kp->id_kategori_pelanggaran }}/edit_ketpelanggaran'" class="cursor-pointer"> --}}
                                        <td  class="text-center">{{$kp->id_kategori_penghargaan}}</td>
                                        <td  class="text-center">{{$kp->kategori_penghargaan}}</td>
                                        <td class="text-center">{{$kp->deskripsi_penghargaan}}</td>
                                        <td class="text-center">{{$kp->point}}</td>
                                        {{-- <td class="text-center">{{$g->password}}</td> --}}

                                        <td class="table-report__action w-56">
                                            <div class="flex justify-center items-center">
                                                <a class="flex items-center mr-3" href="/ketpenghargaan/{{ $kp->id_kategori_penghargaan }}/edit_ketpenghargaan"> <i data-lucide="check-square" class="w-4 h-4 mr-1"></i> Edit </a>
